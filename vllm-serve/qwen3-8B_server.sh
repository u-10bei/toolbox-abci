...
# --- MoE設定ファイル確認（Qwen3-8BはMoEではないが、あっても害はない） ---
...
# Qwen3-8BはMoEモデルではないため、expert parallelは無効化
# if [[ "$MODEL_NAME" == *"MoE"* ]] || [[ "$MODEL_NAME" == *"moe"* ]]; then
